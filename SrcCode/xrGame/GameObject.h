...
#ifndef __INNER_RAYS_ENGINE_GAME_OBJECT_CLASS_H__
#define __INNER_RAYS_ENGINE_GAME_OBJECT_CLASS_H__
#pragma once
...
public:
	...
	// Sends messages only if active and local
	virtual BOOL net_Relevant() { return getLocal(); }
	virtual void spatial_move();
	// Updates only if active and fully initialized by/for network
	virtual BOOL Ready() { return getReady(); }
...
#endif // !__INNER_RAYS_ENGINE_GAME_OBJECT_CLASS_H__
