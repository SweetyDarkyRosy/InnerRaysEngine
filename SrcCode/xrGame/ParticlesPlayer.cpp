///////////////////////////////////////////////////////////////
// ParticlesPlayer.cpp
// Интерфейс для проигрывания партиклов на объекте | Interface for particles
///////////////////////////////////////////////////////////////
...
void CParticlesPlayer::LoadParticles(IKinematics* K)
{
	...
	// Считать список косточек и соответствующих offset'ов куда можно вешать партиклы
...
// Уничтожение партиклов на net_Destroy | Particles destruction on net_Destroy
...
void CParticlesPlayer::StartParticles(const shared_str& ps_name, const Fmatrix& xform, u16 sender_id, int life_time, bool auto_stop)
{
	...
	for (BoneInfoVecIt it = m_Bones.begin(); it != m_Bones.end(); it++)
	{
		...
		// ----- Начать играть партиклы | Start particle updating -----
...
// Остановка партиклов, по истечении их времени жизни | Stopping particles on timeout
...
void CParticlesPlayer::UpdateParticles()
{
	...
	for (BoneInfoVecIt b_it = m_Bones.begin(); b_it != m_Bones.end(); b_it++)
	{
		...
		for (ParticlesInfoListIt p_it = b_info.particles.begin(); p_it != b_info.particles.end(); p_it++)
		{
			...
			// ----- Обновить позицию партиклов | Particles position update -----
			...
			// ----- Обновить время существования | Existance time update -----
