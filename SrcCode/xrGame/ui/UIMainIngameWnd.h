#ifndef	__INNER_RAYS_ENGINE_UI_MAIN_INGAME_WND_CLASS_H__
#define __INNER_RAYS_ENGINE_UI_MAIN_INGAME_WND_CLASS_H__
...
public:
	// Enum'ы соответсвующие предупреждающим иконкам 
	enum EWarningIcons
	{
		ewiAll = 0,
		ewiWeaponJammed,
	...
	// Enum'ы перечисления возможных мигающих иконок
	enum EFlashingIcons
	{
		efiPdaTask = 0,
		efiMail
...
#endif // !__INNER_RAYS_ENGINE_UI_MAIN_INGAME_WND_CLASS_H__
