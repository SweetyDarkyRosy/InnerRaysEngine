...
void animation_planner::add_evaluators()
{
	...
	add_evaluator(eWorldPropertyExitSmartCover, xr_new<CStalkerPropertyEvaluatorConst>(false,
		"exit smart cover"));
	...
	add_evaluator(eWorldPropertyLoopholeFireNoLookout, xr_new<CStalkerPropertyEvaluatorConst>(false,
	...
	add_evaluator(eWorldPropertyLoopholeExitable, xr_new<evaluators::loophole_exitable_evaluator>(m_object,
		"loophole exitable"));
