...
#ifndef __INNER_RAYS_ENGINE_SMART_COVER_LOOPHOLE_CLASS_H__
#define __INNER_RAYS_ENGINE_SMART_COVER_LOOPHOLE_CLASS_H__
...
#endif // !__INNER_RAYS_ENGINE_SMART_COVER_LOOPHOLE_CLASS_H__
