...
#ifndef __INNER_RAYS_ENGINE_SMART_COVER_ACTION_CLASS_INLINE_IMPLEMENTATIONS_H__
#define __INNER_RAYS_ENGINE_SMART_COVER_ACTION_CLASS_INLINE_IMPLEMENTATIONS_H__
...
#endif // !__INNER_RAYS_ENGINE_SMART_COVER_ACTION_CLASS_INLINE_IMPLEMENTATIONS_H__
