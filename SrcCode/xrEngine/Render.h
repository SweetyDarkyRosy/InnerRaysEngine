#ifndef __INNER_RAYS_ENGINE_RENDER_ABSTRACT_CLASS_H__
#define __INNER_RAYS_ENGINE_RENDER_ABSTRACT_CLASS_H__
...
// Per-object render-specific data class
...
public:
	...
	virtual HRESULT shader_compile(LPCSTR name, LPCSTR pSrcData, UINT SrcDataLen, void* pDefines, void* pInclude,
		LPCSTR pFunctionName, LPCSTR pTarget, DWORD Flags, void* ppShader, void* ppErrorMsgs, void* ppConstantTable) = 0;
...
#endif // !__INNER_RAYS_ENGINE_RENDER_ABSTRACT_CLASS_H__
