#ifndef __INNER_RAYS_ENGINE_DEVICE_CLASS_H__
#define __INNER_RAYS_ENGINE_DEVICE_CLASS_H__
#pragma once
...
public:
	...
	{
		xr_vector<fastdelegate::FastDelegate0<> >::iterator I = std::find(seqParallel.begin(),
			seqParallel.end(), delegate);
...
#endif // !__INNER_RAYS_ENGINE_DEVICE_CLASS_H__
