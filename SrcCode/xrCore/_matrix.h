...
public:
	...
	{
		// Get the z basis vector3, which points straight ahead. This is the difference from the eyepoint to the lookat point.
		Tvector vView;
		...
		// The x basis vector3 is found simply with the cross product of the y and z basis vectors
		Tvector vRight;
		vRight.crossproduct(vUp, vView);

		// Start building the Device.mView. The first three rows contains the basis vectors used to rotate the view to point at the lookat point
